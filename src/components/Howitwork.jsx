  ...
  return (
    <>
      <section class="bg-black">
        <div class="lg:max-w-[1140px] max-w-fit lg:pt-[30px] px-3 lg:pt-[161px] justify-between flex-col lg:flex-row items-center flex m-auto">
          <div>
            ...
            <p class="text-[25px] text-white max-w-[636px] leading-[119%] lg:text-[50px]">
              Insights on digital <span class="text-[#BFF747]">innovation</span>{" "}
              and growth
            </p>
          </div>
        ...
        <div class="max-w-[843px] flex overflow-x-auto  py-[40px] gap-[35px] text-white m-auto">
          <button class="px-[32px] hover:bg-lime-600  transition ease-in-out duration-300 py-[11px] border-1 border-white/20 rounded-[16px]">
            All
          </button>
          <button class="px-[32px] hover:bg-lime-600   transition ease-in-out duration-300  py-[11px] border-1 border-white/20 rounded-[16px]">
            Branding & Identity
        ...
        <div class="flex max-w-[1140px] justify-center m-auto overflow-x-auto  gap-[24px]">
          <div class="max-w-[334px] w-full flex items-end justify-center  relative   h-[341px] bg-center bg-cover bg-[url(./src/assets/images/howitwork-img1.png)] rounded-3xl">
          ...
          <div class="max-w-[334px] w-full flex items-end justify-center  relative  h-[341px] bg-center bg-cover bg-[url(./src/assets/images/howitwork-img2.png)] rounded-3xl">
            <div class="w-full h-full absolute top-0 z-4 bg-gradient-to-t from-black to-transparent h-48 w-full;]"></div>
            <p className=" z-5 text-white mb-[20px] font-bold md:text-[20px]">
              Dynamic Digital Campaign
            </p>
          </div>
          <div class="max-w-[334px] w-full flex items-end justify-center  relative  h-[341px] bg-center bg-cover bg-[url(./src/assets/images/howitwork-img3.png)] rounded-3xl">
            <div class="w-full h-full absolute top-0 z-4 bg-gradient-to-t from-black to-transparent h-48 w-full;]"></div>
            <p className=" z-5 text-white mb-[20px] font-bold mg:text-[20px]">
              Dynamic Digital Campaign
            </p>
          </div>
        </div>
