const Runninghead = () => {
  return (
    <div class="bg-lime lg:gap-[40px] overflow-hidden flex ">
      <div class="flex max-w-fit min-w-[120px] ">
        <svg 
        ...
        <p class="font-bold   md:text-[20px] lg:text-[32px]">
          Digital Marketing
        </p>
      </div>
      <div class="flex max-w-fit min-w-[200px] ">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="50"
          height="50"
      ...
      <div class="flex max-w-fit min-w-[200px] ">
        ...
        <p class="font-bold  md:text-[20px] lg:text-[32px]">Custom Branding</p>
      </div>
    </div>
  );
};
